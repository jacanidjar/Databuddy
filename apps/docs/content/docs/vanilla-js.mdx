...
<Cards>
  ...
  <Card title="trackInteractions" description="Track button clicks and form submissions (default: false)" />
  <Card title="trackScrollDepth" description="Track scroll depth milestones (default: false)" />
