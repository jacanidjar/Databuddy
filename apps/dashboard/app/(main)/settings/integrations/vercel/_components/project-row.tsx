...
export function ProjectRow({
	...
	const { data: domainsData, isLoading: isLoadingDomains } = useQuery({
		...orpc.vercel.getProjectDomains.queryOptions({
			input: { projectId: project.id },
		}),
		enabled: isExpanded,
	});

	const triageIssueMutation = useMutation({
		...orpc.vercel.triageIssue.mutationOptions(),
	});
	...
	const unintegrateMutation = useMutation({
		...orpc.vercel.unintegrate.mutationOptions(),
	});
