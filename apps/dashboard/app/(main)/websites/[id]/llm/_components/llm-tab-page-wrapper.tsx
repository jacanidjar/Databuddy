...
interface LlmTabPageWrapperProps {
	children: (websiteId: string, dateRange: DateRange) => React.ReactNode;
}
...
export function LlmTabPageWrapper({ children }: LlmTabPageWrapperProps) {
